...
public final class EventShopItem extends GenericShopItem {
    ...
    public EventShopItem(UUID id, String displayName, Material material, int amount, Map<Enchantment, Integer> enchantments, int position, int tokenPrice) {
        super(id, displayName, material, amount, enchantments, position, 0.0, 0.0);
