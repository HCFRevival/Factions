...
public enum FError {
    ...
    P_CAN_NOT_WARP_EOTW("You can not enter this world during End of the World"),
    P_CAN_NOT_CONNECT_EOTW("End of the World is in-progress. Check back soon!"),
    ...
    F_CANT_KICK_IN_CLAIMS("You can not kick this player while they are inside your faction claim"),
